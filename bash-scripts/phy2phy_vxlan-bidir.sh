...
function start_test {
	...
	sudo $OVS_DIR/utilities/ovs-vsctl --timeout 10 set Interface dpdk0 type=dpdk
...
# if flow setting the VNI , create vxlan port as below
	...
	sudo $OVS_DIR/utilities/ovs-vsctl --timeout 10 set bridge br-phy other_config:hwaddr=00:00:00:00:00:01
	sudo $OVS_DIR/utilities/ovs-vsctl --timeout 10 add-port br-phy dpdk1
	sudo $OVS_DIR/utilities/ovs-vsctl --timeout 10 set Interface dpdk1 type=dpdk
	...
	sudo $OVS_DIR/utilities/ovs-appctl tnl/arp/set br0 10.0.0.1 00:00:00:00:00:01
	sudo $OVS_DIR/utilities/ovs-appctl tnl/arp/set br-phy 10.0.0.2 00:00:00:00:00:02
